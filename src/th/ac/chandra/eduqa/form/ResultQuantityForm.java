...
public class ResultQuantityForm extends CommonForm implements Serializable{
	...
	private String uom;
	private List<ResultQuantityTable> cdsResultList;
	private BigDecimal resultValue;
	private Integer selectResultId; // selected 
	private Integer selectCdsId; // selected
	private String message;
	public ResultQuantityForm() {
		super();
		this.cdsResultList=new ArrayList<ResultQuantityTable>();
	}
	...
	public List<ResultQuantityTable> getCdsResultList() {
		return cdsResultList;
	}

	public void setCdsResultList(List<ResultQuantityTable> cdsResultList) {
		this.cdsResultList = cdsResultList;
	}
