    ...
    <script type="text/javascript"> 
    	...
    	function actChangePageSize(el){
   	 	...
   	 	function actEdit(el){
   	 		...
   	 		var levelActive = $(el).parent('td').parent('tr').children('tbody tr td:nth-child(10)').html();
   	 		//alert(levelActive);
					...
					<c:if test="${not empty levels}">
						<c:forEach items="${levels}" var="level" varStatus="loop">
							<tr>
								...
								<td align="center">
									<img src="<c:url value="/resources/images/button-turn-on.jpg"/>" width="22" height="22" onClick="actEdit(this)" style="cursor: pointer;">
								</td>
