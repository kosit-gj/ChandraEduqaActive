...
<html lang="en">
  <head>
    ...
    <script type="text/javascript"> 
   	  	var dialog,dialog2,gobalTypeName,gobalTypeStName,gobalActive;
    	...
    	function actChangePageSize(el){
   	 	...
   	 	function actEdit(el){
   	 		...
   	 		dataDesc["createDate"] = $(el).parent('td').parent('tr').children('tbody tr td:nth-child(9)').html();
   	 		dataDesc["createBy"] = $(el).parent('td').parent('tr').children('tbody tr td:nth-child(10)').html();
   	 		dataDesc["active"] = $(el).parent('td').parent('tr').children('tbody tr td:nth-child(11)').html();
					...
					<div style="text-align: center;">
						...
						<table style="margin:auto"> 
							...
							<tr >
								...
								<form:radiobutton id="fActive" checked="checked"  class="widt active" path="kpiTypeModel.active" value="1" name="active" />
								เปิดใช้งาน
								<form:radiobutton id="fNotActive" class="widt active" path="kpiTypeModel.active" value="0" name="active" />
								ปิดใช้งาน
