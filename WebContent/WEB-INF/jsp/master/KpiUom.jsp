...
<html lang="en">
  <head>
    ...
    <script type="text/javascript"> 
   	  	var dialog,dialog2, gobalOumName,gobalActive;
    	...
    	function actChangePageSize(el){
   	 	...
   	 	function actEdit(el){
   	 		...
   	 		dataDesc["active"] = $.trim($(el).parent('td').parent('tr').children('tbody tr td:nth-child(10)').html());
   	...
   	<style type="text/css">
   		...
   		table.tableGridTp th:nth-child(2){ width:50%; }
					...
					<div style="text-align: center;">
						...
						<table style="margin:auto"> 
							...
							<tr >
								...
								<form:radiobutton id="fActive" checked="checked"  class="widt active" path="kpiUomModel.active" value="1" name="active" />
								เปิดใช้งาน
								<form:radiobutton id="fNotActive" class="widt active" path="kpiUomModel.active" value="0" name="active" />
								ปิดใช้งาน
