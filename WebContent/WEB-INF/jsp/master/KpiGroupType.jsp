...
<html lang="en">
  <head>
    ...
    <script type="text/javascript"> 
   	  	var dialog,dialog2,gobalTypeName,gobalActive;
    	...
    	function actChangePageSize(el){
   	 	...
   	 	function actEdit(el){
   	 		...
   	 		var active = $(el).parent('td').parent('tr').children('tbody tr td:nth-child(10)').html();
   	 		renderDialog('#formActGp',2,dataId,name,createDate,createBy,active);
   	 	}
   	 	...
   	 	function actSaveEdit(){
   	 		if($.trim(gobalTypeName) == $.trim($("input#fGroupTypeDesc").val()) 
   	 			...
   	 			//alert($.trim($("input.active:checked").val()));
   	 			//alert(gobalActive);
   	 			actCancel();
   	 		}else{
   	 			$('#keyListStatus').val($('#listStatus').val());
	 	...
	 	function actCancel(el){
   	 	...
   	 	function renderDialog(d1,mode,rowNum,value,createDate,createBy,active){
   	...
   	<style type="text/css">
   		...
   		table.tableGridGp th:nth-child(1){ width:5%; }
   		table.tableGridGp th:nth-child(2), table.tableGridGp td:nth-child(2){ width:0%; display:none;}
   		table.tableGridGp th:nth-child(3){ width:65%; }
   		table.tableGridGp th:nth-child(4), table.tableGridGp td:nth-child(4){ width:0%; display:none;}
   		table.tableGridGp th:nth-child(5){ width:10%; }
   		table.tableGridGp th:nth-child(6){ width:10%; }
   		table.tableGridGp th:nth-child(7){ width:10%; }
   		table.tableGridGp th:nth-child(8), table.tableGridGp td:nth-child(8){ width:0%; display:none;} 
   		table.tableGridGp th:nth-child(9), table.tableGridGp td:nth-child(9){ width:0%; display:none;} 
   		table.tableGridGp th:nth-child(10), table.tableGridGp td:nth-child(10){ width:0%; display:none;} 
				...
				<fieldset>
					...
					<div style="text-align: center;">
						...
						<table style="margin:auto">
							<tr>
								<td>ชื่อประเภทตัวบ่งชี้:</td>
								<td><form:input id="fGroupTypeDesc" path="kpiGroupTypeModel.groupTypeName" maxlength="255"/> <br/></td>
							</tr>
							...
							<tr>
								...
								<form:radiobutton id="fActive" checked="checked"  class="widt active" path="kpiGroupTypeModel.active" value="1" name="active" />
								เปิดใช้งาน
								<form:radiobutton id="fNotActive" class="widt active" path="kpiGroupTypeModel.active" value="0" name="active" />
								ปิดใช้งาน
